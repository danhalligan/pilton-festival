...
export function ParallaxBackground({ backgroundImage, className = '', children, muted = false }: ParallaxBackgroundProps) {
  ...
  return (
    <section ref={sectionRef} className={`relative shadow-lg overflow-hidden ${className}`}>
      {/* Parallax Background */}
      <div
      ...
      {muted && (
        <div className="absolute inset-0 bg-forest-800/40" />
      )}
